...
def SignUp_page():
    ...
    if request.method == 'POST':
        ...
        df = pd.read_csv(r"D:\Git Hub\Bee-Fit\resources\User_Info.csv")
        ...
        if username in user_list:
            ...
            if pass_in_data == password_encoded:
                if log==0:
                    ...
                    df.to_csv(r"D:\Git Hub\Bee-Fit\resources\User_Info.csv")
...
def account_creation(username , password,Email_id,Phone):
    ...
    df1 = df1.append(df2)
    df1.to_csv(r"D:\Git Hub\Bee-Fit\resources\User_Info.csv")
